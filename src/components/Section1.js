...
const Section1 = () => {
  return (
    <div className="flex flex-col space-y-16 lg:max-w-[70%] lg:mx-auto px-4 my-16">
      <h1 className="text-[44px] font-bold text-center w-[90%] lg:w-[53%] self-center">
        Unlock the potential within your organization.
      </h1>
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-7">
        <div className="bg-[#F3F1EF] h-[17rem] space-y-10">
