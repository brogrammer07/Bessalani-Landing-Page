...
import section1_1 from "../Assests/section1_1.jpg";
import section1_2 from "../Assests/section1_2.jpg";
import section1_3 from "../Assests/section1_3.jpg";
const Section1 = () => {
  return (
    <div className="flex flex-col space-y-16 lg:max-w-[85%] lg:mx-auto my-16 mb-20 lg:mt-[10rem]">
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 gap-7">
        <div className="bg-[#F3F1EF] md:h-[21rem] h-auto space-y-10">
